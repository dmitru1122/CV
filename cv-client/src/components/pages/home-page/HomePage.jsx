      ...
      content: [
        ...
        },
        {
          ...
          text: [
            ...
            "Develop all frontend functionality from the ground up with React.js",
          ],
        },
      ],
    },
...
function Home() {
  ...
  function scrollToRef(ref) {
    const positionTop =
      ref.current.getBoundingClientRect().y + document.body.scrollTop;
  ...
  return (
    <div className="home">
      <section className="intro-block  container">
        ...
        <div className="background-text intro-block__background-title app-text">
          FRONT-END
        </div>
      </section>
      <div className="home__article-cs">
        <aside className="background-text  background-decoration background-decoration--i app-text">
          I am
        </aside>
        <section ref={aboutMyselfRef}>
          <Suspense fallback={<div>Loading...</div>}>
            <ArticleCs
              title={aboutMyselData.title}
              blocks={aboutMyselData.blocks}
            />
          </Suspense>
          {/* </section>
